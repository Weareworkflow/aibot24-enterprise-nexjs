                    ...
                    {!tenantId && !loaderTenantId ? (
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-3 mb-6 px-1">
                                ...
                                <div className="flex items-center gap-1.5 px-3 py-1 bg-secondary text-white rounded-full text-[9px] font-black uppercase tracking-widest shadow-sm">
                                    V2 REMIX
                                </div>
                            </div>
