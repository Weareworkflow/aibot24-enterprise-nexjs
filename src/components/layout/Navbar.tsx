...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b bg-card text-card-foreground border-border/60 h-14 flex items-center shadow-sm transition-colors duration-300">
